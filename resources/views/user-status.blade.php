...
@section('content')
 ...
 <div class="content main_content">
   ...
   <div class="sidebar-menu">
    <div class="logo">
        <a href="{{url('index')}}" class="logo-normal"><img src="{{ URL::asset('/build/img/AI-Logo.svg') }}" alt="Logo" style="max-width: 70%!important">
</a>
    </div>
    <div class="menu-wrap">
        <div class="main-menu">
            <ul class="nav">
                ...
                <li data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Status" data-bs-custom-class="tooltip-primary">
                    <a href="#" class="active" data-bs-toggle="tab" data-bs-target="#status-menu">
    ...
    <div class="sidebar-group left-sidebar chat_sidebar flex-shrink-0">
        ...
        <div class="tab-content">
            <div class="tab-pane fade " id="chat-menu">
                ...
                <!-- Chats sidebar -->
                <div id="chats1" class="sidebar-content active slimscroll">
                        ...
                        <div class="chat-search-header">                            
                            <div class="header-title d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#new-chat" class="text-primary fs-24 me-2"><i class="ti ti-circle-plus"></i></a>
                                    <div class="dropdown">
                                        <a href="javascript:void(0);" data-bs-toggle="dropdown" class="fs-16 text-default">
                                            <i class="ti ti-dots-vertical"></i>
                                        </a>
                                        <ul class="dropdown-menu p-3">
                                            <li><a class="dropdown-item" href="javascript:void(0);" ><i class="ti ti-send me-2"></i>Invite Others</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="slimscroll">
                        ...
                        <div class="chat-search-header">                            
                            <div class="header-title d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#add-contact" class="text-primary fs-24 me-2"><i class="ti ti-circle-plus"></i></a>
                                </div>
                            </div>
            ...
            <!-- Status -->
            <div class="tab-pane fade active show" id="status-menu">
                <div id="chats" class="sidebar-content active slimscroll">
                    ...
                    <div class="slimscroll">
                        ...
                        <div class="sidebar-body chat-body" id="chatsidebar2">
                           <div class="status-list">
                                ...
                                <div class="chat-users-wrap">
                                    <div class="position-relative">
                                        <a href="{{url('my-status')}}" class="chat-user-list mb-0">
                                            <div class="avatar avatar-lg idle me-2">
                                                <img src="{{URL::asset('/build/img/profiles/avatar-17.jpg')}}" class="rounded-circle" alt="image">
                                            </div>
                                            <div class="chat-user-info">
                                                <div class="chat-user-msg">
                           ...
                           <div class="status-list">
                                ...
                                <div class="chat-users-wrap">
                                    <div class="position-relative">
                                        <a href="{{url('user-status')}}" class="chat-user-list">
                                            <div class="avatar avatar-lg online me-2">
                                                <img src="{{URL::asset('/build/img/profiles/avatar-05.jpg')}}" class="rounded-circle" alt="image">
                                            </div>
                                            <div class="chat-user-info">
                                    ...
                                    <div class="position-relative">
                                        <a href="{{url('user-status')}}" class="chat-user-list mb-0">
                                            <div class="avatar avatar-lg online me-2">
                                                <img src="{{URL::asset('/build/img/profiles/avatar-13.jpg')}}" class="rounded-circle" alt="image">
                                            </div>
                                            <div class="chat-user-info">
                ...
                <div class="sidebar-content active slimscroll">
                    ...
                    <div class="slimscroll">
                            ...
                            <div class="header-title d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu p-3">
                                            <li>
                                                <a href="javascript:;" class="dropdown-item d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#clear-call">
                                                    <span><i class="ti ti-phone-x"></i></span>
                                                    Clear Call Log
                                                </a>
                                            </li>
                                        </ul>
                        ...
                        <div class="sidebar-body chat-body">
                            ...
                            <!-- Left Chat Title -->
                            <div class="dropdown mb-3">
                                <a href="#" class="text-default d-flex align-items-center fs-16" data-bs-toggle="dropdown" aria-expanded="false">
                                    <h5 class="me-2">All Calls</h5><i class="ti ti-chevron-down"></i></a>
                                <ul class="dropdown-menu dropdown-menu p-3">
                                    <li><a class="dropdown-item" href="{{url('all-calls')}}"><i class="ti ti-phone me-2"></i>All Calls</a></li>
                                    <li><a class="dropdown-item" href="{{url('audio-calls')}}"><i class="ti ti-phone-check me-2"></i>Audio Calls</a></li>
                                    <li><a class="dropdown-item" href="{{url('video-calls')}}"><i class="ti ti-video me-2"></i>Video Calls</a></li>
                                </ul>
                            </div>
                            <!-- /Left Chat Title -->
                    ...
                    <div id="carouselIndicators" class="carousel slide slider" data-bs-ride="carousel">
                        ...
                        <div class="status-user-blk">
                            ...
                            <div class="status-voice-group ">
                                    <a href="javascript:;" class="status-pause me-4"><i class="ti ti-player-pause"></i></a>
                                    <a href="javascript:;" class="text-white me-2 fs-24"><i class="ti ti-volume"></i></a>
                                    <a href="javascript:;" class="text-white fs-24"><i class="ti ti-maximize"></i></a>
                        ...
                        <div class="carousel-inner status_slider" role="listbox">
                            ...
                            <div id="target" class="carousel-item active">
                                <img src="{{URL::asset('/build/img/status/status-01.jpg')}}" alt="Image">
                            </div>
                            <div class="carousel-item">
                                <img src="{{URL::asset('/build/img/status/status-02.jpg')}}" alt="Image">
                            </div>
                            <div class="carousel-item">
                                <img src="{{URL::asset('/build/img/status/status-03.jpg')}}" alt="Image">
                            </div>
                            <div class="carousel-item">
                                <img src="{{URL::asset('/build/img/status/status-04.jpg')}}" alt="Image">
                            </div>
                            <div class="carousel-item">
                                <img src="{{URL::asset('/build/img/status/status-05.jpg')}}" alt="Image">
                            </div>
                        </div>
                    </div>
                </div>
