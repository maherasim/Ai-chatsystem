    ...
    @endcomponent
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between flex-wrap pb-0">
                <h6 class="mb-3">Users List <span>200</span> </h6>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right p-3">
                                                ...
                                                <li>
                                                    <a class="dropdown-item rounded-1" href="#"
                                                        data-bs-toggle="modal" data-bs-target="#delete-modal"><i
                                                            class="ti ti-ban me-2"></i>Block</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item rounded-1" href="#"
                                                        data-bs-toggle="modal" data-bs-target="#"><i
                                                            class="ti ti-thumb-down me-2"></i>Report</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item rounded-1" href="#"
                                                        data-bs-toggle="modal" data-bs-target="#"><i
                                                            class="ti ti-link me-2"></i>Unban IP Address</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item rounded-1" href="#"
                                                        data-bs-toggle="modal" data-bs-target="#delete-modal"><i
                                                ...
                                                <li>
                                                    <a class="dropdown-item rounded-1" href="#"
                                                        data-bs-toggle="modal" data-bs-target="#delete-modal"><i
                                                            class="ti ti-ban me-2"></i>Ban From Site</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
