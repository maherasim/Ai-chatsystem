                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center w-100">
                            <img src="{{URL::asset('assets/img/profiles/profile-01.jpg')}}" alt="img"
                    ...
                    <div class="card-footer">
                        <div class="d-flex align-items-center">
                            <span class="avatar avatar-sm avatar-rounded me-2">
                                <img src="{{URL::asset('assets/img/profiles/profile-02.jpg')}}" alt="img">
                            </span>
                ...
                <div class="card text-center">
                    ...
                    <div class="card-body pt-1">
                        <span class="avatar avatar-xl avatar-rounded me-2 mb-2">
                            <img src="{{URL::asset('assets/img/profiles/profile-07.jpg')}}" alt="img">
                        </span>
                        ...
                        <div class="d-flex w-100">
                            <div class="me-4">
                                <span class="avatar avatar-lg avatar-rounded">
                                    <img src="{{URL::asset('assets/img/profiles/profile-03.jpg')}}" alt="img">
                                </span>
                            </div>
                ...
                <div class="card border border-secondary">
                    <div class="card-body">
                        ...
                        <div class="avatar-list-stacked">
                            ...
                            <span class="avatar avatar-sm avatar-rounded">
                                <img src="{{URL::asset('assets/img/profiles/profile-05.jpg')}}" alt="img">
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border border-success">
                    <div class="card-body">
                        ...
                        <div class="avatar-list-stacked">
                            ...
                            <span class="avatar avatar-sm avatar-rounded">
                                <img src="{{URL::asset('assets/img/profiles/profile-04.jpg')}}" alt="img">
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border border-light">
                    <div class="card-body">
                        ...
                        <div class="avatar-list-stacked">
                            ...
                            <span class="avatar avatar-sm avatar-rounded">
                                <img src="{{URL::asset('assets/img/profiles/profile-06.jpg')}}" alt="img">
                            </span>
                            <span class="avatar avatar-sm avatar-rounded">
                                <img src="{{URL::asset('assets/img/profiles/profile-07.jpg')}}" alt="img">
                            </span>
