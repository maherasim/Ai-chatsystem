   			...
   			<!-- User List -->
				<div class="card">
					<div class="card-header d-flex align-items-center justify-content-between flex-wrap pb-0">
						<h6 class="mb-3">Chat List <span>200</span> </h6>
								...
								<tbody>
										...
										<td>
											<div class="d-flex align-items-center">
												<a href="#" class="avatar avatar-md"><img
														...
														class="img-fluid rounded-circle" alt="img"></a>
												<div class="ms-2 profile-name">
													<p class="text-dark mb-0"><a href="#">Charles Sellars</a></p>
												</div>
											</div>
										</td>
										<td>105</td>
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												<a href="#" class="avatar avatar-md"><img
														src="{{URL::asset('assets/img/users/user-13.jpg')}}"
														class="img-fluid rounded-circle" alt="img"></a>
												<div class="ms-2 profile-name">
													<p class="text-dark mb-0"><a href="#">Judy Mercer</a></p>
												</div>
											</div>
										</td>
										<td>200</td>
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												<a href="#" class="avatar avatar-md"><img
														src="{{URL::asset('assets/img/users/user-14.jpg')}}"
														class="img-fluid rounded-circle" alt="img"></a>
												<div class="ms-2 profile-name">
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												<a href="#" class="avatar avatar-md"><img
														src="{{URL::asset('assets/img/users/user-15.jpg')}}"
														class="img-fluid rounded-circle" alt="img"></a>
												<div class="ms-2 profile-name">
													<p class="text-dark mb-0"><a href="#">Gilbert Humphrey</a></p>
												</div>
											</div>
										</td>
										<td>300</td>
										...
										<td>
											<div class="d-flex align-items-center">
												<a href="#" class="avatar avatar-md"><img
														...
														class="img-fluid rounded-circle" alt="img"></a>
												<div class="ms-2 profile-name">
													<p class="text-dark mb-0"><a href="#">Christopher Hurt</a></p>
												</div>
											</div>
										</td>
										<td>180</td>
										...
										<td>
											<div class="d-flex align-items-center">
												<a href="#" class="avatar avatar-md"><img
														...
														class="img-fluid rounded-circle" alt="img"></a>
												<div class="ms-2 profile-name">
													<p class="text-dark mb-0"><a href="#">Chasity Williams</a></p>
												</div>
											</div>
										</td>
										<td>200</td>
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												<a href="#" class="avatar avatar-md"><img
														src="{{URL::asset('assets/img/users/user-18.jpg')}}"
														class="img-fluid rounded-circle" alt="img"></a>
												<div class="ms-2 profile-name">
													<p class="text-dark mb-0"><a href="#">Harry Newton</a></p>
												</div>
											</div>
										</td>
										<td>320</td>
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												<a href="#" class="avatar avatar-md"><img
														src="{{URL::asset('assets/img/users/user-19.jpg')}}"
														class="img-fluid rounded-circle" alt="img"></a>
												<div class="ms-2 profile-name">
													<p class="text-dark mb-0"><a href="#">John Gonzalez</a></p>
												</div>
											</div>
										</td>
										<td>400</td>
									...
									<tr>
										...
										<td>
											<div class="d-flex align-items-center">
												<a href="#" class="avatar avatar-md"><img
														src="{{URL::asset('assets/img/users/user-20.jpg')}}"
														class="img-fluid rounded-circle" alt="img"></a>
												<div class="ms-2 profile-name">
