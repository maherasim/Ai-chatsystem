                ...
                <div class="card">
                    ...
                    <div class="card-body d-flex flex-wrap gap-2">
                        <span class="avatar avatar-xl me-2 avatar-rounded">
                            <img src="{{URL::asset('assets/img/users/user-01.jpg')}}" alt="img">
                        </span>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <span class="avatar avatar-xs me-2">
                            <img src="{{URL::asset('assets/img/users/user-02.jpg')}}" alt="img">
                        </span>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <span class="avatar avatar-xs me-2 online avatar-rounded">
                            <img src="{{URL::asset('assets/img/users/user-03.jpg')}}" alt="img">
                        </span>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <span class="avatar avatar-xs me-2 avatar-rounded">
                            <img src="{{URL::asset('assets/img/users/user-04.jpg')}}" alt="img">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="avatar-list-stacked avatar-group-lg mb-4">
                            <span class="avatar">
                                <img src="{{URL::asset('assets/img/users/user-05.jpg')}}" alt="img">
                            </span>
                            <span class="avatar">
                                <img src="{{URL::asset('assets/img/users/user-05.jpg')}}" alt="img">
                            </span>
                    ...
                    <div class="card-body">
                        <div class="avatar-list-stacked avatar-group-lg mb-4">
                            <span class="avatar avatar-rounded">
                                <img class="border border-white" src="{{URL::asset('assets/img/users/user-06.jpg')}}"
                                    alt="img">
                            </span>
                            <span class="avatar avatar-rounded">
                                <img class="border border-white" src="{{URL::asset('assets/img/users/user-06.jpg')}}"
                            ...
                            <span class="avatar avatar-rounded">
                                <img src="{{URL::asset('assets/img/users/user-06.jpg')}}" alt="img">
                            </span>
