                        ...
                        <div class="card-body">
                            <div class="icons-items">
                                <ul class="icons-list">
                                    ...
                                    <li><i class="ion-arrow-right-a" data-bs-toggle="tooltip" title="ion-arrow-right-a"></i>
                                    </li>
                                    <li><i class="ion-arrow-down-a" data-bs-toggle="tooltip" title="ion-arrow-down-a"></i>
                                    </li>
                                    <li><i class="ion-arrow-left-a" data-bs-toggle="tooltip" title="ion-arrow-left-a"></i>
                                    </li>
                                    <li><i class="ion-arrow-up-b" data-bs-toggle="tooltip" title="ion-arrow-up-b"></i></li>
                                    <li><i class="ion-arrow-right-b" data-bs-toggle="tooltip" title="ion-arrow-right-b"></i>
                                    </li>
                                    <li><i class="ion-arrow-down-b" data-bs-toggle="tooltip" title="ion-arrow-down-b"></i>
                                    </li>
                                    <li><i class="ion-arrow-left-b" data-bs-toggle="tooltip" title="ion-arrow-left-b"></i>
                                    </li>
                                    <li><i class="ion-arrow-up-c" data-bs-toggle="tooltip" title="ion-arrow-up-c"></i></li>
                                    <li><i class="ion-arrow-right-c" data-bs-toggle="tooltip" title="ion-arrow-right-c"></i>
                                    </li>
                                    <li><i class="ion-arrow-down-c" data-bs-toggle="tooltip" title="ion-arrow-down-c"></i>
                                    </li>
                                    <li><i class="ion-arrow-left-c" data-bs-toggle="tooltip" title="ion-arrow-left-c"></i>
                                    </li>
                                    ...
                                    <li><i class="ion-arrow-shrink" data-bs-toggle="tooltip" title="ion-arrow-shrink"></i>
                                    </li>
                                    <li><i class="ion-arrow-expand" data-bs-toggle="tooltip" title="ion-arrow-expand"></i>
                                    </li>
                                    <li><i class="ion-arrow-move" data-bs-toggle="tooltip" title="ion-arrow-move"></i></li>
                                    <li><i class="ion-arrow-resize" data-bs-toggle="tooltip" title="ion-arrow-resize"></i>
                                    </li>
                                    <li><i class="ion-chevron-up" data-bs-toggle="tooltip" title="ion-chevron-up"></i></li>
                                    <li><i class="ion-chevron-right" data-bs-toggle="tooltip" title="ion-chevron-right"></i>
                                    </li>
                                    <li><i class="ion-chevron-down" data-bs-toggle="tooltip" title="ion-chevron-down"></i>
                                    </li>
                                    <li><i class="ion-chevron-left" data-bs-toggle="tooltip" title="ion-chevron-left"></i>
                                    </li>
                                    <li><i class="ion-navicon-round" data-bs-toggle="tooltip" title="ion-navicon-round"></i>
                                    </li>
                                    ...
                                    <li><i class="ion-close-round" data-bs-toggle="tooltip" title="ion-close-round"></i>
                                    </li>
                                    ...
                                    <li><i class="ion-plus-round" data-bs-toggle="tooltip" title="ion-plus-round"></i>
                                    </li>
                                    ...
                                    <li><i class="ion-minus-round" data-bs-toggle="tooltip" title="ion-minus-round"></i>
                                    </li>
                                    ...
                                    <li><i class="ion-information" data-bs-toggle="tooltip" title="ion-information"></i>
                                    </li>
                                    ...
                                    <li><i class="ion-stats-bars" data-bs-toggle="tooltip" title="ion-stats-bars"></i>
                                    </li>
                                    ...
                                    <li><i class="ion-chatbubble" data-bs-toggle="tooltip" title="ion-chatbubble"></i>
                                    </li>
                                    <li><i class="ion-chatbubble-working" data-bs-toggle="tooltip"
                                            title="ion-chatbubble-working"></i></li>
                                    <li><i class="ion-chatbubbles" data-bs-toggle="tooltip" title="ion-chatbubbles"></i>
                                    </li>
                                    ...
                                    <li><i class="ion-person-add" data-bs-toggle="tooltip" title="ion-person-add"></i>
                                    </li>
                                    ...
                                    <li><i class="ion-battery-low" data-bs-toggle="tooltip" title="ion-battery-low"></i>
                                    </li>
                                    ...
                                    <li><i class="ion-calculator" data-bs-toggle="tooltip" title="ion-calculator"></i>
                                    </li>
                                    ...
                                    <li><i class="ion-qr-scanner" data-bs-toggle="tooltip" title="ion-qr-scanner"></i>
                                    </li>
                                    ...
                                    <li><i class="ion-playstation" data-bs-toggle="tooltip" title="ion-playstation"></i>
                                    </li>
                                    ...
                                    <li><i class="ion-videocamera" data-bs-toggle="tooltip" title="ion-videocamera"></i>
                                    </li>
                                    <li><i class="ion-film-marker" data-bs-toggle="tooltip" title="ion-film-marker"></i>
                                    </li>
                                    ...
                                    <li><i class="ion-music-note" data-bs-toggle="tooltip" title="ion-music-note"></i>
                                    </li>
                                    <li><i class="ion-radio-waves" data-bs-toggle="tooltip" title="ion-radio-waves"></i>
                                    </li>
                                    ...
                                    <li><i class="ion-volume-high" data-bs-toggle="tooltip" title="ion-volume-high"></i>
                                    </li>
                                    <li><i class="ion-volume-medium" data-bs-toggle="tooltip"
                                            title="ion-volume-medium"></i></li>
                                    <li><i class="ion-volume-low" data-bs-toggle="tooltip" title="ion-volume-low"></i>
                                    </li>
                                    <li><i class="ion-volume-mute" data-bs-toggle="tooltip" title="ion-volume-mute"></i>
                                    </li>
                                    ...
                                    <li><i class="ion-thumbsdown" data-bs-toggle="tooltip" title="ion-thumbsdown"></i>
                                    </li>
                                    ...
                                    <li><i class="ion-university" data-bs-toggle="tooltip" title="ion-university"></i>
                                    </li>
                                    ...
                                    <li><i class="ion-no-smoking" data-bs-toggle="tooltip" title="ion-no-smoking"></i>
                                    </li>
                                    <li><i class="ion-thermometer" data-bs-toggle="tooltip" title="ion-thermometer"></i>
                                    </li>
                                    <li><i class="ion-speedometer" data-bs-toggle="tooltip" title="ion-speedometer"></i>
                                    </li>
                                    ...
                                    <li><i class="ion-ios7-close" data-bs-toggle="tooltip" title="ion-ios7-close"></i>
                                    </li>
                                    ...
                                    <li><i class="ion-ios7-minus" data-bs-toggle="tooltip" title="ion-ios7-minus"></i>
                                    </li>
                                    ...
                                    <li><i class="ion-ios7-search" data-bs-toggle="tooltip" title="ion-ios7-search"></i>
                                    </li>
                                    ...
                                    <li><i class="ion-ios7-heart" data-bs-toggle="tooltip" title="ion-ios7-heart"></i>
                                    </li>
                                    ...
                                    <li><i class="ion-ios7-cloud" data-bs-toggle="tooltip" title="ion-ios7-cloud"></i>
                                    </li>
                                    ...
                                    <li><i class="ion-ios7-upload" data-bs-toggle="tooltip" title="ion-ios7-upload"></i>
                                    </li>
                                    ...
                                    <li><i class="ion-ios7-reload" data-bs-toggle="tooltip" title="ion-ios7-reload"></i>
                                    </li>
