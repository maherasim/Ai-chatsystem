            ...
            <div class="chat-header">
                <div class="user-details">
                    ...
                    <div class="avatar avatar-lg online flex-shrink-0">
                        <img src="{{ Str::replaceFirst('admin.onlinesystems.info', 'team.onlinesystems.info', asset('storage/' . $user->profile_image)) }} class="rounded-circle" alt="image">
                    ...
                    <div class="chat-body chat-page-group ">
                        ...
                        <div class="project-succes pt-2 pb-2 d-flex flex-wrap justify-content-between align-items-center" style="gap: 10px;">
                            ...
                            <div class="d-flex flex-wrap justify-content-end" style="background: #f8fafc; border-radius: 8px; padding: 6px 10px; gap: 8px; max-width: 100%;">
                                <button class="btn btn-danger addtodo" data-bs-toggle="modal" data-bs-target="#todomodel" style="white-space: nowrap; display:none;">
                                    Add TODO
                                </button>
...
$remaining = max(0, \Carbon\Carbon::createFromTimestamp($ctime, 'UTC')
    ...
    data-image="{{ Str::replaceFirst('admin.onlinesystems.info', 'team.onlinesystems.info', asset('storage/' . $todo->user->profile_image)) }}"
    ...
    data-bs-target="#inreject" style=" cursor:pointer; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 6px rgba(0,0,0,0.1); height:max-content;">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center" style="background-color: #ececec; padding-right:5px;">
                                        <div class="d-flex">
                                            <img src="{{ Str::replaceFirst('admin.onlinesystems.info', 'team.onlinesystems.info', asset('storage/' . $todo->user->profile_image)) }}" class=" me-2" alt="image" style="width: 40px; height: 40px; margin:5px; margin-top:0px; margin-left:0px;">
                                            <div>
...
$remaining = max(0, \Carbon\Carbon::createFromTimestamp($ctime, 'UTC')
    ...
    data-bs-target="#inreject" style=" cursor:pointer; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 6px rgba(0,0,0,0.1); height:max-content;">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center" style="background-color: #ececec; padding-right:5px;">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ Str::replaceFirst('admin.onlinesystems.info', 'team.onlinesystems.info', asset('storage/' . $todo->user->profile_image)) }}" class=" me-2" alt="image" style="width: 40px; height: 40px; margin:5px; margin-left:0px; margin-top:0px;">
                                            <div>
                                                <div style="font-weight: bold;">{{$user->name;}}</div>
                                                <small style="color: gray;">{{ $todo->created_at->format('d:m:Y - H:i') }}</small>
                                            </div>
                    ...
                    <div class="row">
                        @foreach($users as $cuser)
                            <div class="col-md-3 user_div invit-box text-center" 
                                ...
                                <div class="invit-img">
                                    <img src="{{ Str::replaceFirst('admin.onlinesystems.info', 'team.onlinesystems.info', asset('storage/' . $cuser->profile_image)) }}" />
