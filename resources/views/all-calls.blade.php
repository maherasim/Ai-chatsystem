            ...
            <div class="main-menu">
                <ul class="nav">
                    ...
                    <li data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Calls" data-bs-custom-class="tooltip-primary">
                        <a href="" class="active" data-bs-toggle="tab" data-bs-target="#call-menu">
        ...
        <div class="tab-content">
                 ...
                 <div id="chats" class="sidebar-content active slimscroll">
                    ...
                    <div class="slimscroll">
                        ...
                        <div class="chat-search-header">                            
                            <div class="header-title d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    <a href="javascript:void(0);"  class="add-icon btn btn-primary p-0 d-flex align-items-center justify-content-center fs-16 me-2"><i class="ti ti-plus"></i></a>
                                    <div class="dropdown">
                        ...
                        <div class="sidebar-body chat-body" id="chatsidebar">
                            ...
                            <!-- /Left Chat Title -->
                            <div class="tab-content" id="innerTabContent1">
            ...
            <div class="tab-pane fade active show" id="call-menu">
                <div class="sidebar-content active slimscroll">
                    ...
                    <!-- Left Chat Title -->
                    <div class="d-flex  align-items-center mb-3">
                        <h5 class="chat-title me-2">All Calls</h5>
                        <div class="dropdown">
                            ...
                            <ul class=" dropdown-menu dropdown-menu-end p-3" id="innerTab" role="tablist">
                                <li role="presentation">
                                    <a class="dropdown-item active" id="all-calls-tab" data-bs-toggle="tab" href="#all-calls" role="tab" aria-controls="all-calls" aria-selected="true" onclick="changeChat('All Calls')">All Calls</a>
                                </li>
                                <li role="presentation">
                                    <a class="dropdown-item" id="audio-calls-tab" data-bs-toggle="tab" href="#audio-calls" role="tab" aria-controls="audio-calls" aria-selected="false" onclick="changeChat('Audio Calls')">Audio Calls</a>
                                </li>
                                <li role="presentation">
                                    <a class="dropdown-item" id="video-calls-tab" data-bs-toggle="tab" href="#video-calls" role="tab" aria-controls="video-calls" aria-selected="false" onclick="changeChat('Video Calls')">Video Calls</a>
                                </li>
                            </ul>
                        </div>
                        </div>
                    ...
                    <ul>
                        ...
                        <li>
                            <a class="btn no-bg" href="#" data-bs-toggle="dropdown">
                             ...
                             <ul class="dropdown-menu dropdown-menu-end p-3">
                                <li><a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#mute-notification"><i class="ti ti-copy me-2"></i>Copy Number</a></li>
                    ...
                    <div class="chats">
                        ...
                        <div class="chat-content">
                            <div class="chat-profile-name">
                                <h6>Edward Lietz<i class="ti ti-circle-filled fs-7 mx-2"></i><span class="chat-time">02:39 PM</span><span class="msg-read success"></span></h6>
                            </div>
                            <div class="chat-info">
                    ...
                    <div class="chats chats-right">
                        <div class="chat-content">
                            <div class="chat-profile-name text-end">
                                <h6>You<i class="ti ti-circle-filled fs-7 mx-2"></i><span class="chat-time">02:39 PM</span><span class="msg-read success"></span></h6> 
                            </div>
                            <div class="chat-info">
                                <div class="chat-actions">
                                    <a class="#" href="#" data-bs-toggle="dropdown">
                                ...
                                <div class="message-content">
                                    <div class="file-attach">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="overlay">
                                                <a href="#" onclick="openCallDetails()" class="badge badge-success me-2">
                                                    Accept
                                                </a>
            ...
            <div class="card call-details-popup position-absolute">
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <a href="javascript:void(0);" class="float-end user-add bg-primary rounded d-flex justify-content-center align-items-center text-white" data-bs-toggle="modal" data-bs-target="#video_group">
                ...
                <div class="card-footer border-0 pt-0">
                    <div class="call-controll-block d-flex align-items-center justify-content-center">
                        ...
                        <a href="javascript:void(0);" onclick="closeCallDetails()" class="call-controll call-decline d-flex align-items-center justify-content-center">
                            <i class="ti ti-phone"></i>
                        </a>
                        <a href="javascript:void(0);" onclick="closeCallDetails()" data-bs-toggle="modal" data-bs-target="#voice_attend" class="call-controll d-flex align-items-center justify-content-center">
