            ...
            <div class="chat-body chat-page-group slimscroll" style="height: calc(100vh - 180px); overflow-y: auto; scrollbar-width: thin;">
                <div class="messages" id="chatMessagesContainer">
                    ...
                    <div id="emptyChatState" style="display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100%; min-height: 400px; color: #7f8ea3;">
                        <i class="ti ti-message-circle" style="font-size: 64px; margin-bottom: 20px; opacity: 0.5;"></i>
                        <p style="font-size: 16px; margin: 0;">Select a group from the sidebar to start chatting</p>
                    </div>
        ...
        <div class="chat-footer">
            <form class="footer-form">
                <div class="chats reply-chat reply-div" id="reply-div" style="display: none;">
                    ...
                    <div class="chat-content">
                        <div class="chat-profile-name">
                            <h6 id="reply-sender-name">User<i class="ti ti-circle-filled fs-7 mx-2"></i><span class="chat-time" id="reply-time">02:39 PM</span><span class="msg-read success"><i class="ti ti-checks"></i></span></h6>
                        </div>
                        <div class="chat-info">
                            <div class="message-content">
                                <div class="message-reply reply-content" id="reply-content">
                                    Replying to message
                                </div>
                            </div>
                        </div>
                    </div>
                    <a href="#" class="close-replay" onclick="if(window.groupChatManager) window.groupChatManager.clearReply(); return false;">
                        <i class="ti ti-x"></i>
                    </a>
                </div>
                <div class="chat-footer-wrap">
                    ...
                    <div class="form-btn">
                        <button type="button" class="btn btn-primary"><i class="ti ti-send"></i></button>
                    </div>
                </div>
            </form>
        </div>
...
<!-- Static messages removed - now using dynamic chat system -->
            </div>
        </div>
        <div class="chat-footer">
            <form class="footer-form">
                    ...
                    <div class="card-body p-3">
                        <div class="d-flex justify-content-center align-items-center pt-5">
                            <span class="avatar avatar-xxxl bg-soft-primary rounded-circle p-2">
                                <img src="{{ isset($currentUser->image) && $currentUser->image ? asset('storage/' . $currentUser->image) : URL::asset('/build/img/profiles/avatar-06.jpg') }}" class="rounded-circle" alt="user">
                            </span>
                        </div>
                        <div class="d-flex align-items-end justify-content-end">
                            <span class="call-span border border-2 border-primary d-flex justify-content-center align-items-center rounded">
                                <span class="avatar avatar-xl bg-soft-primary rounded-circle p-2">
                                    <img src="{{ isset($currentUser->image) && $currentUser->image ? asset('storage/' . $currentUser->image) : URL::asset('/build/img/profiles/avatar-17.jpg') }}" class="rounded-circle" alt="user">
                                </span>
                            </span>
                        </div>
                    </div>
