                ...
                <div id="chats" class="sidebar-content active slimscroll">
                    ...
                    <div class="slimscroll">
                        ...
                        <div class="chat-search-header">
                            ...
                            <form id="autoUploadForm" action="{{ route('upload.words') }}" method="POST" enctype="multipart/form-data" style="display:none;">
                               @csrf
            ...
            <div style="display: flex; align-items: center; justify-content: space-between; background-color: transparent; border: none; border-radius: 14px; padding: 4px 8px; min-height: 36px;"
                ...
                <div style="margin-left: auto; display: flex; align-items: center;">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end p-2"
                        ...
                        <li><a class="dropdown-item" href="#"><img src="{{ asset('/build/img/Subjects.svg') }}" width="12" height="12" class="me-2">Play</a></li>
                        <li><a class="dropdown-item" href="#"><img src="{{ asset('/build/img/Edit.svg') }}" width="12" height="12" class="me-2">Edit</a></li>
                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#delete-chat"><img src="{{ asset('/build/img/Remove.svg') }}" width="16" height="16" class="me-2">Remove</a></li>
                    </ul>
                </div>
            </div>
        @endforeach
