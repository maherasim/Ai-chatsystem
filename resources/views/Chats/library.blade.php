                        ...
                        <div class="chat-search-header" style="padding: 10px 0px;">
                            ...
                            <script>
                                document.addEventListener("DOMContentLoaded", function() {
                                    ...
                                    const uploadForm = document.getElementById("autoUploadForm");

                                    // Click on + opens file browser
                                    uploadTrigger.addEventListener("click", function() {
                                        hiddenFileInput.click();
                                    });

                                    // When file selected, auto-submit the form
                            ...
                            <!-- Left Chat Title -->
                            <div class="d-flex justify-content-between align-items-center mb-3 mt-3" style="flex-wrap: wrap; gap: 10px;">
                                <h5 class="margin-top:10px;">Kurd Library</h5>
                                <div class="d-flex align-items-center justify-content-between " style="gap:86px;">
                                    <div class="form1">
                            ...
                            <div class="chat-users-wrap">
                                @foreach ($grouped as $letter => $words)
                                <div class="mb-2">
                                    <h6 class="mb-1" style="font-size: 14px;">{{ strtoupper($letter) }}</h6>

                                    @foreach ($words as $word)
                                    <div style="display: flex; align-items: center; justify-content: space-between; background-color: transparent; border: none; border-radius: 14px; padding: 4px 8px; min-height: 36px;"
                                        onmouseover="this.style.backgroundColor='rgba(0,0,0,0.05)'"
                                        onmouseout="this.style.backgroundColor='transparent'">

                                        <a href="#"
                                            style="flex-grow: 1; text-decoration: none; background-color: transparent;">
                                            <p style="font-size: 14px; color:black; margin: 0; line-height: 1.2;">
                                                {{ $word->word }}
                                            </p>
                                        </a>
                                        ...
                                        <div style="margin-left: auto; display: flex; align-items: center;">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end p-2"
                                                style="background-color: transparent !important; border: none !important; box-shadow: none !important; margin: 0;">
                                                <li>
                                                    <a class="dropdown-item" href="#"
                                                        onclick="playWord('{{ addslashes($word->word) }}'); return false;">
                                                        <img src="{{ asset('/build/img/Subjects.svg') }}"
                                                            width="12" height="12" class="me-2">Play
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="#"
                                                        onclick="promptEditWord('{{ $word->_id }}','{{ addslashes($word->word) }}'); return false;">
                                                        <img src="{{ asset('/build/img/Edit.svg') }}"
                                                            width="12" height="12" class="me-2">Edit
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="#"
                                                        onclick="confirmRemoveWord('{{ $word->_id }}'); return false;">
                                                        <img src="{{ asset('/build/img/Remove.svg') }}"
                                                            width="16" height="16" class="me-2">Remove
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                            ...
                            <form id="keywordDeleteForm" method="POST" style="display:none;">
                                @csrf
                                @method('DELETE')
                            </form>
                            ...
                            <script>
                                ...
                                function promptEditWord(id, current) {
                                    const updated = prompt('Edit word:', current);
                                    if (updated === null) return;
                                    const form = document.getElementById('keywordEditForm');
                                    form.action = `{{ url('/keywords') }}/${id}`;
                                ...
                                function confirmRemoveWord(id) {
                                    if (!confirm('Remove this word?')) return;
                                    const form = document.getElementById('keywordDeleteForm');
                                    form.action = `{{ url('/keywords') }}/${id}`;
                                    form.submit();
                                }
                            </script>
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="d-flex profile-list justify-content-between align-items-center">
                                        ...
                                        <a href="{{ url('signin') }}" class="link-icon"><i
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class=" dropdown-menu dropdown-menu-end p-3" id="innerTab1" role="tablist">
                                        <li role="presentation">
                                            <a class="dropdown-item active" id="all-calls-tab" data-bs-toggle="tab"
                                                href="#all-calls" role="tab" aria-controls="all-calls"
                                                aria-selected="true" onclick="changeChat2('All Calls')">All Calls</a>
                                        </li>
                                        <li role="presentation">
                                            <a class="dropdown-item" id="audio-calls-tab" data-bs-toggle="tab"
                                                href="#audio-calls" role="tab" aria-controls="audio-calls"
                                                aria-selected="false" onclick="changeChat2('Audio Calls')">Audio
                                                Calls</a>
                                        </li>
                                        <li role="presentation">
                                            <a class="dropdown-item" id="video-calls-tab" data-bs-toggle="tab"
                                                href="#video-calls" role="tab" aria-controls="video-calls"
                                                aria-selected="false" onclick="changeChat2('Video Calls')">Video
                                                Calls</a>
                                        </li>
                                    </ul>
                                </div>
                                            ...
                                            <a href="{{ url('all-calls') }}" class="chat-user-list">
                                                ...
                                                <div class="chat-user-info">
                                                    <div class="chat-user-msg">
                                                        <h6>Edward Lietz</h6>
                                                        <p><i class="ti ti-phone-outgoing text-purple me-2"></i>20 Min
                                                            Ago</p>
                                                    </div>
                                            ...
                                            <a href="{{ url('all-calls') }}" class="chat-user-list">
                                                ...
                                                <div class="chat-user-info">
                                                    <div class="chat-user-msg">
                                                        ...
                                                        <p class="fs-14">
                                                            <i
                                                                class="ti ti-phone-incoming me-2 fs-14 text-success"></i>
                                                            20 Min Ago
                                                        </p>
                                                    </div>
                                                    <div class="chat-user ">
                                            ...
                                            <a href="{{ url('all-calls') }}" class="chat-user-list">
                                                ...
                                                <div class="chat-user-info">
                                                    <div class="chat-user-msg">
                                                        ...
                                                        <p><i class="ti ti-video-off text-danger me-2"></i>20 Min Ago
                                                        </p>
                                                    </div>
                                                    <div class="chat-user-time">
                                                        <span class="time">08m 12s</span>
                                        ...
                                        <div class="chat-list">
                                            <a href="{{ url('all-calls') }}" class="chat-user-list">
                                                ...
                                                <div class="chat-user-info">
                                                    <div class="chat-user-msg">
                                                        <h6>Sarika Jain</h6>
                                                        <p><i class="ti ti-phone-off text-danger me-2"></i>20 Min Ago
                                                        </p>
                                                    </div>
                                                    <div class="chat-user-time">
                                                        <span class="time">08m 12s</span>
                                            ...
                                            <a href="{{ url('all-calls') }}" class="chat-user-list">
                                                ...
                                                <div class="chat-user-info">
                                                    <div class="chat-user-msg">
                                                        ...
                                                        <p><i class="ti ti-video-minus text-purple me-2"></i>20 Min Ago
                                                        </p>
                                                    </div>
                                                    <div class="chat-user-time">
                                                        <span class="time">08m 12s</span>
