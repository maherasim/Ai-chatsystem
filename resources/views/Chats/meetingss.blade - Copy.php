...
<!-- add user -->
<!-- Modal -->
<div class="modal fade" id="add_user" tabindex="-1" aria-hidden="true" style="visibility: visible;">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content" style="border-radius: 16px; background-color: #ffffff; padding: 24px;">
            ...
            <div style="background-color: #f9f9fb; border-radius: 12px; padding: 16px; margin-bottom: 16px; font-family: sans-serif;">
                <!-- Section Title -->
