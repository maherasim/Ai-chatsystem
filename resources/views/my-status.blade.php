                        ...
                        <div class="chat-search-header">                            
                            <div class="header-title d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    <a href="javascript:void(0);"  class="text-primary fs-24 me-2"><i class="ti ti-circle-plus"></i></a>
                                    <div class="dropdown">
                    ...
                    <div class="slimscroll">
                        ...
                        <div class="chat-search-header">                            
                            <div class="header-title d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    <a href="#" class="call-icon d-flex justify-content-center align-items-center text-white bg-primary rounded-circle me-2" >
            ...
            <div class="user-stories-box ">
                <div class="inner-popup ">
                    <div id="carouselIndicators" class="carousel slide slider" data-bs-ride="carousel">
                        ...
                        <a class="view-status-list br-8 py-1 px-2 position-absolute" href="javascript:void(0);" ><i class="ti ti-eye-check me-2"></i><span class="text-gray-9">25</span></a>
                    </div>
                </div>
            </div>
            <!-- /Status -->
